...
输入：老师，你几岁？（对象为成年老师）
输出：{{"fragment":"你几岁","correction":"您多大了？","type":"语用","type_confident":true,"confidence":0.8,"knowledge_point_id":""}}
...
场景（由系统经 context/seed 字段传入，非学习者输入的一部分）：正式自我介绍。
输入：我叫小明，我很高兴认识大家呢。
输出：{{"fragment":"呢","correction":"（删去'呢'）","type":"语用","type_confident":false,"confidence":0.6,"knowledge_point_id":""}}
